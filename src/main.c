...
int main() {
    ...
    TProd prod1 = TProd_New(file, prod_table, "Produto A", "Descrição A", "Categoria A", "0123", 10.99, 10);
    ...
    func2 = TFunc_GetByPK(file, func_table, 2);
    prod1 = TProd_GetByPK(file, prod_table, 2);
